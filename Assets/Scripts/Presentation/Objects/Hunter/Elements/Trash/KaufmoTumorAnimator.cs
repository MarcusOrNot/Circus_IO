...
public class KaufmoTumorAnimator : MonoBehaviour, INeedKaufmoColor
{
    ...
    [SerializeField] private float _minScaleMultiplierX = 0.5f;

    [SerializeField] private float _maxScaleMultiplierY = 2f;
    [SerializeField] private float _minScaleMultiplierY = 0.5f;

    [SerializeField] private float _maxScaleMultiplierZ = 2f;
    [SerializeField] private float _minScaleMultiplierZ = 0.5f;

    [SerializeField] private float _maxAnimationChangePeriod = 0.07f;
    [SerializeField] private float _minAnimationChangePeriod = 0.03f;
